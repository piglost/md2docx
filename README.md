...
| 🎨 **精准排版** | 自动应用《中国法学》格式（黑体/宋体/仿宋，各级标题字号，两端对齐） |
| ⬛ **纯黑文字** | 三道防线确保零颜色残留 |
| 📐 **首行缩进** | 正文自动首行缩进 2 字符，摘要左右缩进 2 字符 |
| 🔤 **字体统一** | 中文宋体/黑体/仿宋 + 英文 Times New Roman |
...
|------|------|------|------|------|------|
| 正标题 | 黑体 | 小二 18pt | ✓ | 居中 | — |
| 摘要标签 | 宋体 | 五号 10.5pt | ✓ | 两端 | — |
| 摘要内容 | 仿宋 | 五号 10.5pt | — | 两端 | 左右 2 字符 |
| 一级标题 | 黑体 | 四号 14pt | — | 居中 | — |
| 二级标题 | 黑体 | 小四 12pt | — | 两端 | — |
| 三级标题 | 宋体 | 小四 12pt | — | 两端 | 首行 2 字符 |
| **正文** | **宋体** | **小四 12pt** | **—** | **两端** | **首行 2 字符** |
| 脚注 | 宋体 | 小五 9pt | — | — | — |
...
然后对 Claude 说：「把这个 md 转成 word」即可。
...
- [NEU-ZHA/legal-ai-skills](https://github.com/NEU-ZHA/legal-ai-skills) — 法学 AI 技能参考
- 《中国法学》编辑部 — 格式规范参照
